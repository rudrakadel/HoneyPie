...
http_audits_log_local_file_path = r"C:\Users\Public\Github\HoneyPie\log_files\http_audit.log"
...
def baseline_web_honeypot(input_username="admin", input_password="admin"):
    ...
    def login():
        ...
        if username == input_username and password == input_password:
            return 'Please go to https://www.google.com/'
        else:
...
run_app(port=5000, input_username="admin", input_password="admin")
